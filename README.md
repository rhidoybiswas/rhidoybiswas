# Hi, I'm Rhidoy Biswas 👋

Software Implementation Engineer  
Python Developer & Automation (Internal Software Engineering)  
ASA International Microfinance Service Ltd., Dhaka, Bangladesh
...
- Integrated REST APIs using `requests`, processed and transformed JSON data for system interoperability and reporting pipelines.  
- Developed email automation solutions using `smtplib`, enabling automated notifications and communication workflows.  
- Currently building hands-on projects using FastAPI, Google BigQuery, and Prefect to strengthen expertise in modern data pipelines, workflow orchestration, and scalable API design.
